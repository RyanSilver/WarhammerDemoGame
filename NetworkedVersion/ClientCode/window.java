...
public class window extends Application {
    ...
    Button egdUnit = new Button("Eldar Guardian Defenders");
       ...
       smUnit.setOnAction(e-> {
         
               ButtonClicked(e,0);
         
       });
       erUnit.setOnAction(e-> {
          
               ButtonClicked(e, 1);
         
       });
       daUnit.setOnAction(e-> {
        
               ButtonClicked(e, 2);
          
       });
       egdUnit.setOnAction(e->{
     ...
     //   scene1 = new Scene(pane1, 1200, 625);
        ...
        primaryStage.setTitle("warhammer game Client");
       ...
       phaseAdv.setLayoutY(600);
        ...
        phaseAdv.setOnAction(e->{
              if(turnM.getNetworkedTurn()==true &&!firstTurn)
              {
             turnM.incPhase();
...
for (int i = 0; i < 2; i++) {
        ...
        for (int i = 0; i < blueTeam.length; i++) {
         ...
         movementAssist.setOnMouseClicked(r -> {
            if (!turnM.selected.moved && turnM.isMove() && !firstTurn) {
    ...
    /**
     * 
     * takes information sent via sockets and changes UI in response. 
     */
public void decodeMessage(String m)
  ...
  /**
   * 
   * Updates game status via sockets 
   */
